  ...
  const salvar = async () => {
    ...
    try {
      ...
      if (id === "nova") {
        ...
        router.push(`/admin/provas/${data.id}`);
      } else {
    ...
    >
      ...
      <Card className="border-[#2a2a3a] bg-[#12121a]">
        ...
        <CardContent className="space-y-4">
          <div>
            <Label htmlFor="titulo-adm" className="text-[#f0ece4]">Título</Label>
            <Input
              id="titulo-adm"
              value={titulo}
          ...
          <div>
            <Label htmlFor="duracao-adm" className="text-[#f0ece4]">Duração (minutos)</Label>
            <Input
              id="duracao-adm"
              type="number"
              value={duracao}
