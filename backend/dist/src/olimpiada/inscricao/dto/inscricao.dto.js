...
}).refine((data) => data.instituicaoId || data.instituicao, { message: "Instituição é obrigatória", path: ["instituicao"] }).refine((data) => data.cursoId || data.curso, { message: "Curso é obrigatório", path: ["curso"] });
